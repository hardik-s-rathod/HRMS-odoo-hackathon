  ...
  return (
    <div className="space-y-8 animate-[fadeIn_0.3s_ease-out]">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 border-b border-slate-700/50 pb-8">
        <div>
          ...
          <div className="relative">
            <span className="absolute left-4 top-3 text-slate-500 font-bold">
              ₹
            </span>
            <input
              type="number"
              ...
              } text-white rounded-lg py-2.5 pl-8 pr-4 font-mono text-lg focus:outline-none focus:ring-1 focus:ring-violet-500 transition-colors`}
            />
          </div>
        </div>
        <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
        {/* Earnings */}
        <div>
          <h3 className="text-white text-lg font-semibold mb-6 border-b border-slate-700 pb-2">
            Salary Components
          </h3>
          ...
          <div className="space-y-5">
            ...
            <ComponentRow
              ...
              value={components.standardAllowance}
              percent="Fixed"
            />
            <ComponentRow
              label="Performance Bonus"
              value={components.performanceBonus}
              percent="8.33% of Basic"
            />
            <ComponentRow
              label="Leave Travel Allowance"
              value={components.lta}
              percent="8.33% of Basic"
            />
            <ComponentRow
              label="Fixed Allowance"
              value={components.fixedAllowance}
              percent="Balance"
              highlight
            />
          </div>
        ...
        <div>
          ...
          <div className="space-y-5">
            ...
            <ComponentRow
              ...
              value={components.professionalTax}
              percent="Fixed"
              isDeduction
            />
            ...
            <div className="mt-8 pt-6 border-t border-slate-700/50">
              ...
              <button
                onClick={() => alert("Downloading Salary Slip... (Mock PDF)")}
                className="w-full mt-6 py-3 bg-violet-600 hover:bg-violet-700 text-white font-bold rounded-lg shadow-lg shadow-violet-500/20 flex items-center justify-center gap-2 transition-all"
              >
...
const ComponentRow = ({
  ...
  <div className="flex items-center justify-between group">
    ...
    <div className="flex items-center gap-4 flex-1 justify-end">
      <div
        className={`w-32 text-right font-mono font-medium ${
          highlight
            ? "text-violet-400"
            : isDeduction
            ? "text-rose-400"
